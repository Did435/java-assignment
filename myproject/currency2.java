...
public currency2(String nameValue, String shortNameValue) {
...
public static ArrayList<currency2> init() {

ArrayList<currency2> currencies = new ArrayList<currency2>();

currencies.add( new currency2("US Dollar", "USD") );

currencies.add( new currency2("Euro", "EUR") );

currencies.add( new currency2("British Pound", "GBP") );

currencies.add( new currency2("Swiss Franc", "CHF") );

currencies.add( new currency2("Chinese Yuan Renminbi", "CNY") );

currencies.add( new currency2("Japanese Yen", "JPY") );
