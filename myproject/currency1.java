...
public currency1(String nameValue, String shortNameValue) {
...
public static ArrayList<Currency1> init() {

ArrayList<Currency1> currencies = new ArrayList<Currency1>();

currencies.add( new Currency1("US Dollar", "USD") );

currencies.add( new Currency1("Euro", "EUR") );

currencies.add( new Currency1("British Pound", "GBP") );

currencies.add( new Currency1("Swiss Franc", "CHF") );

currencies.add( new Currency1("Chinese Yuan Renminbi", "CNY") );

currencies.add( new Currency1("Japanese Yen", "JPY") );
